...
using MinimalAPI.Dominios.Interfaces;
using MinimalAPI.Dominios.ModelViews;
using MinimalAPI.Dominios.Servicos;
using MinimalAPI.Infraestrutura.Db;
using MinimalAPI.Dominios.Enuns;
...
ErroDeValidacao validaDTO(VeiculoDTO veiculoDTO)
{
    ...
    if(veiculoDTO.Ano < 1950)
        validacao.Mensagens.Add("Veiculo muito antigo, aceito somente anos superiores de 1950");
